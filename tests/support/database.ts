...
export async function resetTestDatabase(client: ReturnType<typeof postgres>) {
  await client`TRUNCATE audit_log, attendance, member_faces, ministry_members, lineup_assignments, lineup_songs, songs, members, cell_groups, services, service_schedules, users, app_settings CASCADE`;
